...
It's assumed that you're already familiar with Python. The `official tutorial`\_ in the Python docs is a great way to learn or review first.
...
:gh:`The tutorial project is available as an example in the Flask repository <examples/tutorial>`, if you want to compare your project
